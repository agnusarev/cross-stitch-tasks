...
def upgrade() -> None:
    ...
    op.create_table(
        "types_of_base",
        sa.Column("id", sa.INTEGER(), nullable=False, autoincrement=True, comment="Идентификатор вида основы"),
    ...
    op.create_table(
        "types_of_image",
        sa.Column("id", sa.INTEGER(), nullable=False, autoincrement=True, comment="Идентификатор типа изображения"),
    ...
    op.create_table(
        "jobs",
        sa.Column("id", sa.INTEGER(), nullable=False, autoincrement=True, comment="Идентификатор работы"),
    ...
    op.create_table(
        "processes",
        sa.Column("id", sa.INTEGER(), nullable=False, autoincrement=True, comment="Идентификатор процесса"),
